...
import net.digitalpear.aqua_creepers.common.entities.custom.CustomMinecartEntity;
...
public class CustomMinecartItem extends Item {
    ...
    private static final DispenserBehavior DISPENSER_BEHAVIOR = new ItemDispenserBehavior() {
        ...
        public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
            ...
            UnderwaterTntMinecartEntity abstractMinecartEntity = UnderwaterTntMinecartEntity.createUnderwaterTntMinecartEntity(world, d, e + g, f);
