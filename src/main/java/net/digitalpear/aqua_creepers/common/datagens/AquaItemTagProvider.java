...
public class AquaItemTagProvider extends FabricTagProvider<Item> {
     ...
     */
    public AquaItemTagProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
